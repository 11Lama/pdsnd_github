...
def get_filters():
    ...
    while city_name.lower() not in CITY_DATA:
        city_name = input("\nname of the city to analyze: chicago, new york or washington)\n")
    ...
    while month_name.lower() not in MONTH_DATA:
        month_name = input("\nname of the month to filter by: january, february, ... , june, or all\n")
    ...
    while day_name.lower() not in DAY_DATA:
        day_name = input("\nWhat is the name of the day to filter data? (Input either 'all' to apply no day filter or monday, tuesday, ... sunday)\n")
        if day_name.lower() in DAY_DATA:
            day = day_name.lower()
        else:
            print("Sorry we were not able to get the name of the day to filter data\n")
